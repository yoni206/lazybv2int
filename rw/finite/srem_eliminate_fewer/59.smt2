...
(define-fun abs_rem ((a (_ BitVec 59)) (b (_ BitVec 59))) (_ BitVec 59) (bvurem (abs a) (abs b)))
(define-fun left () (_ BitVec 59) (bvsrem x y))
(define-fun right () (_ BitVec 59) (ite (negative x) (bvneg (abs_rem x y)) (abs_rem x y)))
