...
(define-fun u ((a (_ BitVec 63)) (b (_ BitVec 63))) (_ BitVec 63) (bvurem (abs a) (abs b)))
(define-fun neg_u ((a (_ BitVec 63)) (b (_ BitVec 63))) (_ BitVec 63) (bvneg (u a b)))
(define-fun cond_0 () Bool (= (u x y) (_ bv0 63)))
...
(define-fun left () (_ BitVec 63) (bvsmod x y))
(define-fun right () (_ BitVec 63) (ite cond_0 (u x y) (ite cond_1 (u x y) (ite cond_2 (bvadd (neg_u x y) y) (ite cond_3 (bvadd (u x y) y) (neg_u x y))))))
