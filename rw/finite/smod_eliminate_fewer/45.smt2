...
(define-fun u ((a (_ BitVec 45)) (b (_ BitVec 45))) (_ BitVec 45) (bvurem (abs a) (abs b)))
(define-fun neg_u ((a (_ BitVec 45)) (b (_ BitVec 45))) (_ BitVec 45) (bvneg (u a b)))
(define-fun cond_0 () Bool (= (u x y) (_ bv0 45)))
...
(define-fun left () (_ BitVec 45) (bvsmod x y))
(define-fun right () (_ BitVec 45) (ite cond_0 (u x y) (ite cond_1 (u x y) (ite cond_2 (bvadd (neg_u x y) y) (ite cond_3 (bvadd (u x y) y) (neg_u x y))))))
